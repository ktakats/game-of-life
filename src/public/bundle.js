...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('#pause').click(function () {
	  ...
	  (0, _jquery2.default)(this).addClass('pushed');
	});
	
	(0, _jquery2.default)('#start').click(function () {
	  if (running == 0) {
	    running = 1;
	    (0, _jquery2.default)('#pause').removeClass('pushed');
	    runIt();
	  }
	});
	...
	(0, _jquery2.default)('.size').click(function () {
	  if (running == 1) {
	    running = 0;
	  }
	  ...
	  var pick = (0, _jquery2.default)(this).attr('id');
	  (0, _jquery2.default)(this).addClass('pushed');
	  ...
	  switch (pick) {
	    case "small":
	      ...
	      cellsize = "15px";
	      contsize = "340px";
	      (0, _jquery2.default)('#normal').removeClass('pushed');
	      (0, _jquery2.default)('#large').removeClass('pushed');
	      break;
	    case "normal":
	      width = 50;
	      height = 50;
	      ...
	      cellsize = "11px";
	      contsize = "650px";
	      (0, _jquery2.default)('#small').removeClass('pushed');
	      (0, _jquery2.default)('#large').removeClass('pushed');
	      break;
	    case 'large':
	      width = 100;
	  ...
	  createBoard();
	  activate();
	  (0, _jquery2.default)('.cell').css({ "width": cellsize, "height": cellsize });
	  (0, _jquery2.default)('#container').css({ "width": contsize, "height": contsize });
	});
	
	(0, _jquery2.default)('.speed').click(function () {
	  if (running == 1) {
	    running = 0;
	  }
	  var pick = (0, _jquery2.default)(this).attr('id');
	  ...
	  switch (pick) {
	    case "slow":
	      delay = 500;
	      (0, _jquery2.default)('#medium').removeClass('pushed');
	      (0, _jquery2.default)('#fast').removeClass('pushed');
	      break;
	    case "medium":
	      delay = 200;
	      (0, _jquery2.default)('#slow').removeClass('pushed');
	      (0, _jquery2.default)('#fast').removeClass('pushed');
	      break;
	    case "fast":
	      delay = 50;
	...
	function createBoard() {
	  ...
	  Cell = _react2.default.createClass({
	    displayName: 'Cell',
	    ...
	    render: function render() {
	      var out = this.props.board.map(function (cell, i) {
	        return _react2.default.createElement('div', { className: cell.status, key: i, id: i });
	      });
	...
	function activate() {
	  ...
	  (0, _jquery2.default)('.cell').click(function () {
	    var Num = (0, _jquery2.default)(this).attr('id');
	...
	function cellCheck(i) {
	  ...
	  var c3 = i + width + 1;
	  if (i % width == 0) {
	    a1 = i - 1;b1 = i + width - 1, c1 = i + 2 * width - 1;
	  }
	  if ((i + 1) % width == 0) {
	    a3 = i - 2 * width + 1;b2 = i - width + 1;c3 = i + 1;
	  }
	  if (i == 0) {
	    a1 = cells - width - 1;
	  }
	  ...
	  var liveNeighbors = neighborStatus.filter(function (x) {
	    return x != "cell dead";
	  }).length;
	...
	function Draw() {
	  //draws the board
	  (0, _jquery2.default)('#gen').text(generation);
	  //ReactDOM.render(
	  (0, _reactDom.render)(_react2.default.createElement(Cell, { board: board }), document.getElementById('container'));
	}
